...
const LoadAllInstalationProfiles = async () => {
    ...
    const INSTALLATION_PROFILES = {
        ...
        "minimal-google-drive"    : require("../InstallationProfiles/google-drive-release/minimal.install.json"),
        "standard-google-drive"   : require("../InstallationProfiles/google-drive-release/standard.install.json")
    }
