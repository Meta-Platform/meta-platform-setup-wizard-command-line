...
[Meta Platform Setup Wizard CLI - versão 0.0.18](https://github.com/Meta-Platform/meta-platform-setup-wizard-command-line/releases/download/0.0.18/meta-platform-setup-wizard-command-line-0.0.18-preview-linux-x64)
...
1. Faça o download do binário:
   ```bash
   wget https://github.com/Meta-Platform/meta-platform-setup-wizard-command-line/releases/download/0.0.18/meta-platform-setup-wizard-command-line-0.0.18-preview-linux-x64 -O mywizard
   ```
